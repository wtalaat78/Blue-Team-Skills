...
1. **Strict Two-Phase Rule**: NEVER apply code changes directly without first generating and presenting the **Pre-Fix Security Assessment Report** containing the 11 domain scores (0-10), vulnerability dockets (CVSS v3.1, PoC, remediation), and awaiting explicit user approval.
